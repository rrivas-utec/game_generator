...
Check <svg width="18" height="18"><use xlink:href="./media/font_awesome/check-square-regular.svg"/></svg> 

## <image src="./media/font_awesome/check-square-regular.svg" width="18"/> Requirements <a name="requirement"/>
